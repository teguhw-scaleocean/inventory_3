...
import 'package:inventory_v3/presentation/receipt/receipt_both/screens/receipt_both_detail_screen.dart';
...
class ReceiptBothItemCard extends StatelessWidget {
  final Receipt receipt;

  const ReceiptBothItemCard({super.key, required this.receipt});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ReceiptBothDetailScreen(receipt: receipt),
          ),
        );
      },
      child: Container(
