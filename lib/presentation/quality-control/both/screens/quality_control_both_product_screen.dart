...
class QualityControlBothProductScreen extends StatefulWidget {
  final Pallet product;
  final String tracking;
  final String status;

  const QualityControlBothProductScreen(
      {super.key,
  ...
  @override
  State<QualityControlBothProductScreen> createState() =>
      _QualityControlBothProductScreenState();
}

class _QualityControlBothProductScreenState
    extends State<QualityControlBothProductScreen>
