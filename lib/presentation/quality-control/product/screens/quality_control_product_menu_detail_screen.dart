...
class QualityControlProductMenuDetailScreen extends StatefulWidget {
  ...
  const QualityControlProductMenuDetailScreen(
      {super.key, this.qualityControl, this.scanBarcode = ""});

  @override
  State<QualityControlProductMenuDetailScreen> createState() =>
      _QualityControlProductMenuDetailScreenState();
}

class _QualityControlProductMenuDetailScreenState
  ...
  onShowSuccessDialogLastVersion() {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: const CustomAppBar(title: "Quality Control Detail"),
        body: ListView(
          children: [
            Container(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  buildReturnAndDamageButtonSection(
                    status: qualityControl.status,
                    onTapReturn: () {
                      // SN: 9
                      // Lots: 1
                      // No Tracking: 10
                      if (qualityControl.id == 9 ||
                          qualityControl.id == 1 ||
                          qualityControl.id == 10) {
  ...
  Widget buildReturnAndDamageButtonSection({
